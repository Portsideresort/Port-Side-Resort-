...
const translations = {
  en: {
    ...
    happyHourDesc: "Enjoy music at the Beach Bar with DJ, live percussion and saxophone in a vibrant holiday atmosphere.",
  ...
  de: {
    ...
    happyHourTitle: "Happy Hour",
    happyHourDesc: "Genießen Sie an der Beach Bar Musik mit DJ, Live-Percussion und Saxofon in lebendiger Urlaubsatmosphäre.",
    miniDiscoTitle: "Mini Disco",
  ...
  tr: {
    ...
    happyHourTitle: "Happy Hour",
    happyHourDesc: "Beach Bar alanında DJ, canlı perküsyon ve saksafon eşliğinde enerjik müziğin keyfini çıkarın.",
    miniDiscoTitle: "Mini Disco",
  ...
  ru: {
    ...
    happyHourDesc: "Наслаждайтесь музыкой в Beach Bar с диджеем, живой перкуссией и саксофоном в яркой атмосфере отдыха.",
