...
const translations = {
  en: {
    ...
    specialEventsIntro: "Music, dancing and unforgettable holiday moments for every age.",
  ...
  de: {
    ...
    specialEventsIntro: "Musik, Tanz und unvergessliche Urlaubsmomente für jedes Alter.",
    happyHourTitle: "Happy Hour",
  ...
  tr: {
    ...
    specialEventsIntro: "Her yaşa uygun müzik, dans ve unutulmaz tatil anları.",
    happyHourTitle: "Happy Hour",
